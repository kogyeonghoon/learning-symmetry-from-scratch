# Symmetry Learning with PDEs

First, generate PDE trajectories:
...
for augmentation:
```
python train_fno.py --device cuda --pde KdV --train_samples 512 --n_delta 4 --transform_batch_size 32 --delta_exp {experiment_name} --sigma 0.1 0.1 0.1 0 --n_transform 16 --p_original 0.5
```